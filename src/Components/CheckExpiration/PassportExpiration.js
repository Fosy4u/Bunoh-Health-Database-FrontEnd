...
class PassportExpiration extends React.Component {
    ...
    componentDidMount() {
        ...
        fetch('http://localhost:3001/checkpassport')
                    ...
                    <Table className='' aria-label="customized table">
                        <TableHead>
                            <TableRow>
                                ...
                                <StyledTableCell align="right">Passport Expiry Date&nbsp;</StyledTableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            ...
                            {this.state.Status.map((user) => (
                                <StyledTableRow key={user.id}>
                                    ...
                                    <StyledTableCell align="right">{user.passportexpirydate}</StyledTableCell>
                                </StyledTableRow>
                            ))}
                        </TableBody>
                    </Table>
...
export default PassportExpiration;