...
class DbsExpiration extends React.Component {
    ...
    componentDidMount() {
        ...
        fetch('http://localhost:3001/checkdbs')
                    ...
                    <Table className='' aria-label="customized table">
                        <TableHead>
                            <TableRow>
                                ...
                                <StyledTableCell align="right">DBS Expiry Date&nbsp;</StyledTableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            ...
                            {this.state.Status.map((user) => (
                                <StyledTableRow key={user.id}>
                                    ...
                                    <StyledTableCell align="right">{user.dbsexpirydate}</StyledTableCell>
                                </StyledTableRow>
                            ))}
                        </TableBody>
                    </Table>
